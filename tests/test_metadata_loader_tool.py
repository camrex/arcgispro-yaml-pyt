...
def test_metadata_loader_tool_creation():
    ...
    from toolbox.framework.metadata.loader_tool import execute_metadata_loader

    config_path = Path("toolbox/tools/config/tools/load_tool_metadata.yml")
...
def test_metadata_loader_in_toolbox():
    ...
    config_dir = Path("toolbox/tools/config")
    ...
    assert metadata_tool.config == "tools/load_tool_metadata.yml"
