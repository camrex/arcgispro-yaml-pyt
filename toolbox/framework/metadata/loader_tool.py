...
def execute_metadata_loader(parameters: list) -> None:
    ...
    try:
        ...
        if toolbox_config.documentation:
            ...
            from toolbox.framework.metadata.generator import create_toolbox_metadata_xml
        ...
        for tool_ref in toolbox_config.tools:
            ...
            # Generate metadata
            try:
                from toolbox.framework.metadata.generator import generate_metadata_for_tool
